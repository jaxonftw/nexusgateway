use crate::consts::{
    CURVE_FC_MODEL_NAME, CURVE_FC_REQUEST_TIMEOUT_MS, CURVE_MESSAGES_KEY, CURVE_PROVIDER_HINT_HEADER,
    CURVE_ROUTING_HEADER, CURVE_STATE_HEADER, ARC_FC_CLUSTER, CHAT_COMPLETIONS_PATH,
