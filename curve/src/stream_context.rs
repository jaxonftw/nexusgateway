use crate::consts::{
    ...
    CURVE_PROVIDER_HINT_HEADER, CURVE_ROUTING_HEADER, CURVE_STATE_HEADER, CURVE_UPSTREAM_HOST_HEADER,
...
use public_types::common_types::open_ai::{
    CurveState, ChatCompletionChunkResponse, ChatCompletionTool, ChatCompletionsRequest,
...
impl StreamContext {
    ...
    fn function_call_response_handler(
        ...
        debug!("curve  => openai request body: {}", json_string);
