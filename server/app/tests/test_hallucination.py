...
def test_hallucination_prompt(is_hallucinate_sample):
    ...
    client = OpenAI(base_url="https://api.fc.curve.com/v1", api_key="EMPTY")

    # List models API
    model = client.models.list().data[0].id
    assert model == "Curve-Function"
    ...
    resp = client.chat.completions.create(
        model="Curve-Function", messages=messages, extra_body=extra_body, stream=True
    )
