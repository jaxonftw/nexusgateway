...
from app.utils import load_yaml_config, get_server_logger
...
fc_url = os.getenv("FC_URL", "https://api.fc.curve.com/v1")
...
async def chat_completion(req: ChatMessage, res: Response):
    ...
    logger.info(
        f"server => curve _fc: {chosen_model}, messages: {json.dumps(messages)}"
    )
