...
Curve helps you easily personalize your applications by enabling calls to application-specific (API) operations 
...
Curve does this via its purpose-built Curve-FC1B LLM - the fastest (200ms p90 - 10x faser than GPT-4o) and cheapest 
