...
Curve-Function
-------------------------
The `Curve-Function <https://huggingface.co/collections/curvelaboratory/Curve-function-66f209a693ea8df14317ad68>`_ collection of large language models (LLMs) is a collection state-of-the-art (SOTA) LLMs specifically designed for **function calling** tasks.
...
~~~~~~~~~~~~~~~~~~~~~~~~~~~
First, create or identify the backend function you want Curve to call. This could be an API endpoint, a script, or any other executable backend logic.
...
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
Next, map the function to a prompt target, defining the intent and parameters that Curve will extract from the user’s prompt.
Specify the parameters your function needs and how Curve should interpret these.
...
Step 3: Curve Takes Over
~~~~~~~~~~~~~~~~~~~~~~~
Once you have defined the functions and configured the prompt targets, Curve Gateway takes care of the remaining work.
...
.. figure:: /_static/img/curve _network_diagram_high_level.png
   ...
   High-level network flow of where Curve Gateway sits in your agentic stack. Managing incoming and outgoing prompt traffic


Once a downstream function (API) is called, Curve Gateway takes the response and sends it an upstream LLM to complete the request (for summarization, Q/A, text generation tasks).
For more details on how Curve Gateway enables you to centralize usage of LLMs, please read :ref:`LLM providers <llm_provider>`.

By completing these steps, you enable Curve to manage the process from validation to response, ensuring users receive consistent, reliable results - and that you are focused
