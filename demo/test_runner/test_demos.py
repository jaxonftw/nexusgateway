import json
import os
from common import get_curve _messages
import pytest
import requests
...
CURVEGW_ENDPOINT = os.getenv(
    "CURVEGW_ENDPOINT", "http://localhost:10000/v1/chat/completions"
)
...
def test_demos(test_data):
    ...
    response = requests.post(CURVEGW_ENDPOINT, json=input)
