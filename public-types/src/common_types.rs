...
// https://api.qdrant.tech/master/api-reference/securve /points
#[derive(Debug, Clone, Serialize, Deserialize)]
pub struct Securve PointsRequest {
    pub vector: Vec<f64>,
    pub limit: i32,
...
#[derive(Debug, Clone, Serialize, Deserialize)]
pub struct Securve PointsResponse {
    pub result: Vec<Securve PointResult>,
    pub status: String,
    pub time: f64,
}
